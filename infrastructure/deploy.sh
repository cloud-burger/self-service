...
argocd app create self-service --repo https://github.com/cloud-burger/self-service.git --revision feature/kubernetes --path infrastructure/gitops/argocd/workloads/self-service --dest-server https://kubernetes.default.svc --dest-namespace argocd
